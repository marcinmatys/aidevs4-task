...
{HUB_BASE_URL}/data/tutaj-twój-klucz/failure.log

Plik zmienia się o północy (nowe sygnatury czasu), więc pobieraj go ponownie, jeśli pracujesz na nocną zmianę. 

Przykłądowa zawartość pliku logów:
[2026-09-19 06:00:16] [INFO] Primary feed acknowledgment on WTRPMP received. Rotation profile is smooth.
[2026-09-19 06:00:42] [INFO] Waste routing telemetry from WSTPOOL2 is synchronized. Buffer trend is unchanged.
[2026-09-19 06:01:09] [INFO] Coolant circulation pulse from WTRPMP is active. ECCS8 reports normal transfer demand.
[2026-09-19 06:01:35] [INFO] Steam pressure readback from STMTURB12 is within startup envelope. No oscillation detected.
[2026-09-19 06:02:01] [INFO] Thermal scan on ECCS8 completed. Pump manifold temperature remains acceptable.
[2026-09-19 06:02:28] [WARN] Pressure jitter near STMTURB12 is above baseline. Automatic damping remains engaged.
[2026-09-19 06:02:54] [INFO] Boot sequence checkpoint accepted on FIRMWARE. Control loop latency remains within nominal margin.
[2026-09-19 06:03:20] [WARN] Thermal drift on ECCS8 exceeds advisory threshold. Corrective ramp is queued.
[2026-09-19 06:03:47] [INFO] Coolant circulation pulse from WTRPMP is active. ECCS8 reports normal transfer demand.
[2026-09-19 06:04:13] [CRIT] ECCS8 reported runaway outlet temperature. Protection interlock initiated reactor trip.
[2026-09-19 06:04:39] [WARN] Fill trajectory in WTANK07 is slower than expected. Cooling reserve may become constrained.
[2026-09-19 06:05:05] [INFO] Actuator response packet from STMTURB12 accepted. Torque variance stays low.
[2026-09-19 06:05:32] [ERRO] FIRMWARE validation queue returned nonblocking fault set. Runtime proceeds in constrained mode.
[2026-09-19 06:05:58] [WARN] Flow margin on WTRPMP is below preferred startup profile. Monitoring continues without immediate trip.
[2026-09-19 06:06:24] [INFO] Waste routing telemetry from WSTPOOL2 is synchronized. Buffer trend is unchanged.
[2026-09-19 06:06:51] [INFO] Primary feed acknowledgment on WTRPMP received. Rotation profile is smooth.

# Jak wysłać odpowiedź?

Metodą POST na {HUB_BASE_URL}/verify:
